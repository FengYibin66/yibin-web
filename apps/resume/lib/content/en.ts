...
export const en: SiteContent = {
  ...
  labUi: {
    ...
    tutorials: {
      corridor_enter:    { title: 'Explorer',    label: 'Click or tap a door to enter' },
      corridor_explore:  { title: 'Wanderer',    label: 'Scroll or swipe to explore' },
      about_scroll:      { title: 'Sky Walker',  label: 'Scroll to fly through my story' },
      projects_inspect:  { title: 'Director',    label: 'Drag to look around, click a screen' },
    ...
    tour: {
      welcome: 'Yibin Feng, AI engineer. Civil engineering to AI, in one minute.',
      about: 'About: Imperial structural engineering, then NUS computer science.',
      projects: 'Projects: AI tutoring, growth platforms, full-stack builds.',
      publications: 'Publications: five papers since 2025, one first-authored.',
    ...
    loading: {
      ...
      failed: 'The room stayed closed',
      failedHint: 'The room could not be prepared.',
      retry: 'Try again',
    ...
    hints: {
      ...
      howToExplore: 'How to explore the lab',
