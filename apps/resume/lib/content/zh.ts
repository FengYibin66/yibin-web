...
export const zh: SiteContent = {
  ...
  labUi: {
    ...
    tutorials: {
      corridor_enter:    { title: '探索者',   label: '点一扇门进去' },
      corridor_explore:  { title: '漫游者',   label: '滚动或滑动，往走廊深处走' },
      about_scroll:      { title: '云上行者', label: '滚动，穿过我的故事' },
      projects_inspect:  { title: '导演',     label: '拖动环视，点一块屏幕' },
