...
export const zh: SiteContent = {
  ...
  labUi: {
    ...
    tour: {
      welcome: '冯一镔，AI 工程师。一分钟，从土木讲到 AI。',
      about: '关于：先是帝国理工的结构工程，后是新加坡国立的计算机。',
      projects: '项目：AI 辅导、增长平台、全栈交付。',
      publications: '论文：2025 年起五篇，一篇一作。',
    ...
    fallback: {
      ...
      webglBody: '你的浏览器或设备不支持 3D 渲染。Classic 版本有完全相同的内容。',
      webglCta: '打开 Classic 视图 \u2192',
      slowConnection: '网络较慢？打开 Classic 视图 \u2192',
      bugFixed: 'BUG 已修复！',
      drawing: '绘制中\u2026',
    },
    results: {
  ...
  hero: {
    ...
    tagline: '构建能够理解并影响人类行为的智能系统。London · Singapore · Beijing · Silicon Valley',
    cta: '查看我的工作',
    scrollHint: '向下滚动探索',
  },
