...
| 批 | 内容 | ADR |
|----|------|-----|
| 1 · 止血 | 字体族名、paper_tear 映射、Contact 云、Navbar token、cancelTeleport 接线、Art Critic 走 store、删死代码、hydration、console 清理、GALLERY ICELAND、年份、鸭子字体 | 无 |
| 2 · 架构 | 上表五份 ADR 的实现，分六步 | 全部 |
| 3 · 打磨 | 成就队列、i18n、Gallery 修整、可达性、位置持久、门坐标去重、帧率降级 | 无 |
